...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__guards_auth_service__ = __webpack_require__("./src/app/guards/auth.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: "profile", component: __WEBPACK_IMPORTED_MODULE_11__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_14__guards_auth_service__["a" /* AuthGuardService */]] },
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__guards_auth_service__["a" /* AuthGuardService */]],
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.handleLoginSubmit = function (e) {
        var _this = this;
        var user = {
...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-dark bg-dark mb-4\">\n  <a class=\"navbar-brand\" routerLink=\"/\">MEAN APP</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarCollapse\" aria-controls=\"navbarCollapse\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n  <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">\n    <ul class=\"navbar-nav ml-auto\">\n      <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" data-toggle=\"collapse\" data-target=\".navbar-collapse.show\">\n        <a class=\"nav-link\" routerLink=\"/profile\" style=\"color: lightgray\">Profile</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" data-toggle=\"collapse\" data-target=\".navbar-collapse.show\">\n        <a class=\"nav-link\" routerLink=\"/register\" style=\"color: lightgray\">Sign Up</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" data-toggle=\"collapse\" data-target=\".navbar-collapse.show\">\n        <a class=\"nav-link\" routerLink=\"/login\" style=\"color: lightgray\">Login<span class=\"sr-only\">(current)</span></a>\n      </li>\n      <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" data-toggle=\"collapse\" data-target=\".navbar-collapse.show\">\n        <a class=\"nav-link\" href=\"#\" style=\"color: lightgray\" (click)=\"handleLogoutClick($event)\">Logout</a>\n      </li>\n    </ul>\n  </div>\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.handleLogoutClick = function (e) {
        e.preventDefault();
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.loadProfile().subscribe(function (data) {
            _this.user = data;
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.handleRegisterSubmit = function (e) {
        var _this = this;
        e.preventDefault();
        var _a = this, name = _a.name, email = _a.email, username = _a.username, password = _a.password;
        var newUser = {
        ...
        this.authService.registerUser(newUser).subscribe(function (data) {
            if (data.msg) {
                _this.router.navigate(['/login']);
                _this.flashMessage.show("You've successfully registered and can now log in", { cssClass: "alert-success" });
            }
            else {
                _this.router.navigate(['/register']);
                _this.flashMessage.show("Problem with registration", { cssClass: "alert-danger" });
            }
        });
    };
...
var AuthGuardService = /** @class */ (function () {
    function AuthGuardService(authService, router, flashMessage) {
        this.authService = authService;
        this.router = router;
        this.flashMessage = flashMessage;
    }
    ...
    AuthGuardService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]])
    ], AuthGuardService);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (newUser) {
        ...
        return this.http.post("http://localhost:5000/users/register", newUser, { headers: headers })
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateNotEmpty = function (newUser) {
    ...
    ValidateService.prototype.validateIsEmail = function (email) {
